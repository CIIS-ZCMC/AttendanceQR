...
export const AnomalyStatusContants = {
    ...
    description: "This action is recorded — do it again and this ID of yours will be reported to HR.",
}
...
export const recordedStatusContants = {
    ...
    description: "You have already submitted your attendance for this time. Please try again during the allowed schedule. You may also check your email for the receipt confirmation of your recorded attendance.",
}
